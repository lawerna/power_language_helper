class SentencesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @sentence.update(sentence_params)
        format.html { redirect_to @sentence, notice: "Sentence was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sentences_path, notice: "Sentence was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_sentence
      @sentence = Sentence.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def sentence_params
      params.expect(sentence: [ :body ])
    end
end
