...
RSpec.describe LessonsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: lesson.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      lesson = Lesson.create! valid_attributes
      get :edit, params: {id: lesson.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Lesson" do
        expect {
          post :create, params: {lesson: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "renders a response with 422 status (i.e. to display the 'new' template)" do
        post :create, params: {lesson: invalid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        lesson = Lesson.create! valid_attributes
        put :update, params: {id: lesson.to_param, lesson: invalid_attributes}, session: valid_session
        expect(response).to have_http_status(:unprocessable_content)
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested lesson" do
      lesson = Lesson.create! valid_attributes
      expect {
        delete :destroy, params: {id: lesson.to_param}, session: valid_session
      }.to change(Lesson, :count).by(-1)
    end
